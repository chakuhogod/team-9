...
<html>
    <head>
        <meta charset="UTF-8">
        <title>{{ isset($htmlTitle) ? $htmlTitle : trans('ui.layout.html-title') }} - BankLinq</title>
    ...
    <body class="skin-red">
        ...
        <!-- Bootstrap 3.3.2 JS -->
        <script src="{{ asset ("/bower_components/AdminLTE/bootstrap/js/bootstrap.js") }}" type="text/javascript"></script>
        <!-- AdminLTE App -->
